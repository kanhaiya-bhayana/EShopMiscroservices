...
public class UpdateOrderHandler(IApplicationDbContext _dbContext)
    : ICommandHandler<UpdateOrderCommand, UpdateOrderResult>
{
    ...
    {
        var updateShippingAddress = Address
        ...
        var updateBillingAddress = Address
        ...
        var updatePayment = Payment
            .Of(orderDto.Payment.CardName, orderDto.Payment.CardNumber, orderDto.Payment.Expiration,
